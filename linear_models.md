...
This regrssion diagnostic shows problems with the regression. We need to
go back and check our hypothesis and the type of regression chosen.
...
This is more exploratory what is the effect of stars in brooklyn,
Manhattan and queens? Fit different models -
...
Let’s nest even more Look at the same within the neighbourhood in
Manhattan.
